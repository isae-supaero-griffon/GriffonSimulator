...
def test_onera_physical_test_1():
    ...
    simulation_params = {'ox_flow': 0.087585365, 'safety_thickness': 0.005, 'dt': 0.01, 'max_burn_time': 8}
...
def test_onera_physical_test_2():
    ...
    simulation_params = {'ox_flow': 0.0876, 'safety_thickness': 0.005, 'dt': 0.01, 'max_burn_time': 9}
